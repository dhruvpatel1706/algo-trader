"""Gold agent — placeholder container for gold-class strategies.

v1 ships with no strategies wired in. Universe is the gold ETF list; strategies
will land here as the gold variants of trend/pullback are productionised.
"""
...
class GoldAgent(Agent):
    """Container for gold-class strategies (empty in v1)."""
